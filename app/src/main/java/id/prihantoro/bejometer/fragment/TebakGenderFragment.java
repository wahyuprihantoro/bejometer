...
import id.prihantoro.bejometer.dialog.AskRatingDialog;
 ...
 */
@EFragment(R.layout.fragment_tebakgender)
public class TebakGenderFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    @FragmentArg
    String tanggalSaiki;
    @ViewById
    EditText nama1;
    ...
    public void hitung() {
        ...
        if (isValid(nama1, tanggal1)) {
            ...
            retrofit.getService(BejoService.class)
                    ...
                    .enqueue(new CustomCallback<BejoResponse, TebakGenderResult>(new TebakGenderResult()));
    ...
    @Subscribe
    public void onBejoResponse(TebakGenderResult result) {
